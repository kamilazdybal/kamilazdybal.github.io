...
2. You will get negative results, *i.e.* you will try to prove something and the results you'll get just won't show any evidence in support of your hypotheses.
  - Learn to fail quickly. I couldn't stress this point more. If something doesn't seem to work, move on. A Ph.D. is time-bounded, and you might not have the luxury to stubbornly pursue an idea that doesn't seem to be promising for months. Try to see if you can implement a modification to the idea, but be mindful of your time-frame. A good advisor should be able to tell you: Try this for another 2 weeks, and if that doesn't work, then we'll revise our plan. When you give up on an idea, keep it in your notes for your future research.
...
3. You will find out that someone else had the same idea as you did and has already published it. This happens all the time in research. Things to do when that happens to you:
  ...
  - Chances are, you can still bring some new perspective to the story. Even if it's not as impactful contribution as: We've discovered XYZ, it can still be: We've applied XYZ to this particular problem., or We extend the method XYZ by introducing this modification. In fact, in moooost of the published research, researchers develop a tiny, incremental advance to the existing method. It's very rare that researchers present a breakthrough that no one has ever thought about before!

4. You will get grant and award rejections.
  - Again, take the opportunity to learn. Every grant proposal, research statement, nomination letter that you or your advisor writes teaches you how to disseminate, showcase, or think about your research. Even if your research proposal is rejected, the time that you took to prepare it was a time well-spent. Just by the act of writing your proposal, you can gain clarity on what you'd like to develop in the coming months or years.
  - Know that there's a lot of luck that goes into getting a grant or an award, and luck is completely outside of your control!
